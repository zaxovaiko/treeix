...
export function ErrorBlock({ message, onOpenTerminal }: { message: string; onOpenTerminal: (() => void) | null }): React.JSX.Element {
  return (
    <div className="flex items-start gap-2 rounded-lg bg-red-400/5 px-3 py-2 text-xs text-red-300 ring-1 ring-red-400/30">
      ...
      {onOpenTerminal && (
        <button onClick={onOpenTerminal} className="shrink-0 text-foreground hover:underline">
          Open in terminal
        </button>
      )}
    </div>
